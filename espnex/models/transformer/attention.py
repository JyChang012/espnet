...
from flax.linen import MultiHeadDotProductAttention as OriginalMultiHeadDotProductAttention, combine_masks
...
def dot_product_attention_weights(query: Array,
    ...
    Args:
      ...
      precision: numerical precision of the computation see `jax.lax.Precision`
        for details.
      mdl: module for storing attention weights using mdl.sow('intermediates', ...).
    ...
    if mdl is not None:
        mdl.sow('intermediates', 'attention_weights', attn_weights)
...
def dot_product_attention(query: Array,
    ...
    attn_weights = dot_product_attention_weights(query, key, bias, mask, broadcast_dropout, dropout_rng, dropout_rate,
                                                 deterministic, dtype, precision, mdl)
...
class MultiHeadDotProductAttention(Module):
    ...
    def __call__(self,
        ...
        x = self.attention_fn(
            ...
            dtype=self.dtype,
            precision=self.precision,
            mdl=self)  # pytype: disable=wrong-keyword-args
